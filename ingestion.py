...
chroma = Chroma(
    collection_name="docs-helper",
    embedding_function=embeddings,
    persist_directory="./chroma_db",
)

t_extract = TavilyExtract()
t_map = TavilyMap(max_depth=2, max_breadth=20, max_pages=1000)
t_crawl = TavilyCrawl()
...
async def main():
    ...
    log_success(f"TavilyCrawl: Harvested {len(all_docs)} pages.")
